    ...
    <main className="min-h-screen p-8 bg-white pt-20">
      ...
      <div className="mb-12">
        ...
        <ul className="list-disc pl-6 space-y-2 text-gray-800">
          <li>
            Collaborated with cross-functional teams to develop Python-based AI
            solutions, enhancing workflow efficiency by 15%.
          </li>
          <li>
            Built a chatbot, reducing manual queries by 30% and improving
            client satisfaction.
          </li>
          <li>
            Predicted product prices with 90% accuracy using LSTM models for
            market strategy.
          </li>
        </ul>
        <div className="mt-4">
      ...
      <div className="mb-12">
        ...
        <ul className="list-disc pl-6 space-y-2 text-gray-800">
          ...
          <li>
            Integrated real-time eye and face movement tracking to detect
            cheating, boosting detection by ~25%.
          </li>
          <li>
            Implemented voice recognition and frequency detection with
            sub-second latency for real-time speech/audio applications.
          </li>
        </ul>
        <div className="mt-4">
          <a
